...
<c:url value='/dang-nhap.htm' var="url_login"></c:url>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form  action="${url_login}" method="Post"   class="login100-form validate-form" style="padding-top: 80px;">
				...
				<div class="login100-more" style="background-image: url('resources/login/images/work4.jpg');">
				</div>
			</div>
		</div>
	</div>
